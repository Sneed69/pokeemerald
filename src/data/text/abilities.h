...
static const u8 sSturdyDescription[] = _("Cannot be knocked out\nwith one hit.");
...
static const u8 sSandVeilDescription[] = _("Evasion is boosted when\ninside a sandstorm.");
...
static const u8 sObliviousDescription[] = _("Unaffected by infatuation,\nTaunt and Intimidate.");
...
static const u8 sRoughSkinDescription[] = _("Inflicts damage to attackers\non contact."); //Also used by Iron Barbs
...
static const u8 sHugePowerDescription[] = _("Doubles Attack."); //Also used for Pure Power
static const u8 sPoisonPointDescription[] = _("May poison attackers\non contact.");
static const u8 sPoisonTouchDescription[] = _("Contact attacks may\npoison the target.");
...
static const u8 sEarlyBirdDescription[] = _("Awakens from sleep twice\nas fast as other Pokémon.");
...
static const u8 sPlusDescription[] = _("Raises Sp. Atk if paired with\na partner with Minus or Plus.");
static const u8 sMinusDescription[] = _("Raises Sp. Atk if paired with\na partner with Plus or Minus.");
...
static const u8 sSnowCloakDescription[] = _("Evasion is boosted while\ninside a hailstorm.");
...
static const u8 sUnburdenDescription[] = _("Doubles Speed after its held\nitem is used or lost.");
...
static const u8 sHydrationDescription[] = _("At the end of each turn, rain\ncures status conditions.");
...
static const u8 sKlutzDescription[] = _("Can't use any held items.");
...
static const u8 sFlowerGiftDescription[] = _("Boosts the team's Attack\nand Sp. Def in sunshine.");
...
static const u8 sToxicBoostDescription[] = _("Boosts Attack while\nsuffering from poison.");
static const u8 sFlareBoostDescription[] = _("Boosts Sp. Atk while\nsuffering from a burn.");
...
static const u8 sSapSipperDescription[] = _("Absorbs incoming Grass-type\nmoves, raising Attack.");
...
static const u8 sSweetVeilDescription[] = _("Prevents itself and ally\nPokémon from falling asleep.");
...
static const u8 sMercilessDescription[] = _("Attacks become critical hits\nif the target is poisoned.");
...
static const u8 sLongReachDescription[] = _("Uses moves without making\ncontact with its targets.");
